...
> Reference-free RAG evaluation framework measuring faithfulness, context precision, and response recall.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/ragas/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-ragas.git
cd tp-ragas
```
...
```bash
kubectl port-forward deployment/tp-ragas 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── ragas_eval.py     # Main configuration file
```
...
---
*Generated by [RAGAS Evaluator Studio](https://pradeeptalari14.github.io/portfolio/tools/ragas/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
